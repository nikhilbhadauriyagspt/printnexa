...
import { ChevronRight, Shield, Clock, Mail, MapPin } from 'lucide-react';
    ...
    return (
        <div className="bg-white min-h-screen font-sans selection:bg-brand-600 selection:text-white pb-20">
            <SEO 
                ...
                fallbackTitle="Privacy Policy | Prime Fix Solutions" 
                fallbackDesc="Our commitment to protecting your personal information and privacy." 
            />
            ...
            <article className="container mx-auto px-6 py-16 lg:py-24">
                <div className="max-w-4xl mx-auto prose prose-slate prose-lg lg:prose-xl">
                    <FadeIn>
                        ...
                        <ul>
                            <li>Visit our website at <a href="http://primefixsolutions.shop/" className="text-brand-600 font-bold">http://primefixsolutions.shop/</a> or any website of ours that links to this Privacy Notice</li>
                        ...
                        <p>
                            Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:primefixsolutions.us@outlook.com" className="text-brand-600 font-bold">primefixsolutions.us@outlook.com</a>.
                        </p>

                        <div className="bg-slate-50 p-8 rounded-[2rem] border border-slate-100 my-12">
                            <h2 className="text-2xl font-black text-slate-900 uppercase mt-0 mb-6">SUMMARY OF KEY POINTS</h2>
                        ...
                        <ol className="text-brand-600 font-bold">
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">1. WHAT INFORMATION DO WE COLLECT?</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
                        ...
                        <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="http://primefixsolutions.shop/cookie-policy">http://primefixsolutions.shop/cookie-policy</a>.</p>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">8. DO WE COLLECT INFORMATION FROM MINORS?</h2>
                        ...
                        <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age or the equivalent age as specified by law in your jurisdiction, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or the equivalent age as specified by law in your jurisdiction or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age or the equivalent age as specified by law in your jurisdiction has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18 or the equivalent age as specified by law in your jurisdiction, please contact us at <a href="mailto:primefixsolutions.us@outlook.com">primefixsolutions.us@outlook.com</a>.</p>

                        <h2 className="text-2xl font-black text-slate-900 uppercase">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                        ...
                        <p><strong>Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: <a href="http://primefixsolutions.shop/cookie-policy">http://primefixsolutions.shop/cookie-policy</a>.</p>
                        <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:primefixsolutions.us@outlook.com">primefixsolutions.us@outlook.com</a>.</p>

                        <h2 className="text-2xl font-black text-slate-900 uppercase">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                        ...
                        <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at primefixsolutions.us@outlook.com, by calling toll-free at XXXXXXXXXX, by visiting <a href="http://primefixsolutions.shop/contact">http://primefixsolutions.shop/contact</a>, or by referring to the contact details at the bottom of this document.</p>
                        ...
                        <h3>Appeals</h3>
                        <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:primefixsolutions.us@outlook.com">primefixsolutions.us@outlook.com</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">12. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                        <p>If you have questions or comments about this notice, you may email us at <a href="mailto:primefixsolutions.us@outlook.com">primefixsolutions.us@outlook.com</a> or contact us by post at:</p>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 uppercase">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
